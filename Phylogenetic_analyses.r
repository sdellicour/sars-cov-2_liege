...
# 10. Jackknife on phylogenetic branches (randomly keeping 75% of branches)
# 11. Comparing intra- and inter-province/municipality lineage migration events
# 12. Estimating and plotting dispersal statistics associated with lineages
...
dir.create(file.path("Phylogeographic_runs/Jack_Liege_ext1"), showWarnings=F)
dir.create(file.path("Phylogeographic_runs/Jack_Liege_ext2"), showWarnings=F)
for (i in 1:nberOfExtractionFiles)
	{
		...
		tab1 = read.csv(paste0("Phylogeographic_runs/All_Liege_ext1/TreeExtractions_",i,".csv"), header=T)
		tab2 = read.csv(paste0("Phylogeographic_runs/All_Liege_ext2/TreeExtractions_",i,".csv"), header=T)
		nberOfBranchesToKeep = round(0.75*dim(tab1)[1]); indices = sample(c(1:dim(tab1)[1]), nberOfBranchesToKeep, replace=F); indices = indices[order(indices)]
		write.csv(tab1[indices,], paste0("Phylogeographic_runs/Jack_Liege_ext1/TreeExtractions_",i,".csv"))
		write.csv(tab2[indices,], paste0("Phylogeographic_runs/Jack_Liege_ext2/TreeExtractions_",i,".csv"))
	}
...
localTreesDirectories[[3]] = paste0("Phylogeographic_runs/All_Liege_ext1")
localTreesDirectories[[4]] = paste0("Phylogeographic_runs/Jack_Liege_ext1")
...
directories[[3]] = "All_dispersal_statistics/Dispersal_statistics_all_in_Liege_ext1/"
directories[[4]] = "All_dispersal_statistics/Dispersal_statistics_all_jack_Liege_ext1/"
communes = shapefile("Shapefile_communes/Shapefile_post_codes.shp")
provinces = spTransform(raster::getData("GADM", country="BEL", level=2), crs(communes))
...
if (showingPlots)
	{
		mcc = read.csv("Phylogeographic_runs/All_clades.csv", head=T)
		minYear = min(mcc[,"startYear"]); maxYear = max(mcc[,"endYear"])
		ats = c(minYear, decimal_date(ymd("2020-03-01")), decimal_date(ymd("2020-04-01")), decimal_date(ymd("2020-05-01")),
				decimal_date(ymd("2020-06-01")), decimal_date(ymd("2020-07-01")), decimal_date(ymd("2020-08-01")),
				decimal_date(ymd("2020-09-01")), decimal_date(ymd("2020-10-01")), decimal_date(ymd("2020-11-01")), maxYear)
		...
		dev.new(width=7, height=4); par(mgp=c(0,0,0), oma=c(1,1,0.5,0.5), mar=c(1.5,1.5,1,1))
		directory = "All_dispersal_statistics/Dispersal_statistics_all_in_Liege_ext1/"
		tab4 = read.csv(paste0(directory,analysis,"_among_provinces_communes_proportions.csv"), header=T)
		plot(tab4[,1], tab4[,5], type="l", axes=F, ann=F, ylim=c(0.2,0.9), xlim=c(decimal_date(ymd("2020-02-28")),maxYear), col=NA)
		...
		slicedTimes = tab5[,1]; lower_l_1 = tab5[,6]; upper_l_1 = tab5[,7]
		...
		slicedTimes = tab4[,1]; lower_l_1 = tab4[,6]; upper_l_1 = tab4[,7]
		xx_l = c(slicedTimes,rev(slicedTimes)); yy_l = c(lower_l_1,rev(upper_l_1))
		getOption("scipen"); opt = options("scipen"=20); polygon(xx_l, yy_l, col=col2, border=0)
		lines(slicedTimes, tab4[,5], lwd=1, col=col1)
		axis(side=2, lwd.tick=0.2, cex.axis=0.6, mgp=c(0,0.20,0), lwd=0.2, tck=-0.015, col.tick="gray30", col.axis="gray30", col="gray30")
		axis(side=1, lwd.tick=0.2, cex.axis=0.6, mgp=c(0,0.00,0), lwd=0.2, tck=-0.015, col.tick="gray30", col.axis="gray30", col="gray30",
			 at=ats, labels=c("","01-03","01-04","01-05","01-06","01-07","01-08","01-09","01-10","01-11",""))
		par(new=T)
		directory = "All_dispersal_statistics/Dispersal_statistics_all_in_Liege_ext2/"
		...
		plot(tab1[,1], tab1[,3], type="l", axes=F, ann=F, ylim=c(0,900), xlim=c(decimal_date(ymd("2020-02-15")),maxYear), col=NA)
		slicedTimes = tab1[,1]; numberOfBranchesMedianValue = tab1[,3]
		lines(slicedTimes, numberOfBranchesMedianValue, lwd=1, col="red")
		axis(side=4, pos=maxYear, lwd.tick=0.2, cex.axis=0.6, mgp=c(0,0.20,0), lwd=0.2, tck=-0.015, col.tick="gray30", col.axis="gray30", col="gray30")
	}
...
spreadStatistics(localTreesDirectory, nberOfExtractionFiles, timeSlices, onlyTipBranches, showingPlots, outputName, nberOfCores, slidingWindow) 
localTreesDirectory = paste0("Phylogeographic_runs/All_Liege_ext2")
dir.create(file.path("All_dispersal_statistics/Dispersal_statistics_all_in_Liege_ext2/"), showWarnings=F)
outputName = paste0("All_dispersal_statistics/Dispersal_statistics_all_in_Liege_ext2/",analysis)
spreadStatistics(localTreesDirectory, nberOfExtractionFiles, timeSlices, onlyTipBranches, showingPlots, outputName, nberOfCores, slidingWindow) 
localTreesDirectory = paste0("Phylogeographic_runs/Jack_Liege_ext2")
dir.create(file.path("All_dispersal_statistics/Dispersal_statistics_all_jack_Liege_ext2/"), showWarnings=F)
outputName = paste0("All_dispersal_statistics/Dispersal_statistics_all_jack_Liege_ext2/",analysis)
spreadStatistics(localTreesDirectory, nberOfExtractionFiles, timeSlices, onlyTipBranches, showingPlots, outputName, nberOfCores, slidingWindow)
localTreesDirectory = paste0("Phylogeographic_runs/1st_wave_ext2")
outputName = paste0("All_dispersal_statistics/Dispersal_statistics_1st_wave_ext2/",analysis)
dir.create(file.path("All_dispersal_statistics/Dispersal_statistics_1st_wave_ext2/"), showWarnings=F)
spreadStatistics(localTreesDirectory, nberOfExtractionFiles, timeSlices, onlyTipBranches, showingPlots, outputName, nberOfCores, slidingWindow) 
localTreesDirectory = paste0("Phylogeographic_runs/2nd_wave_ext2")
outputName = paste0("All_dispersal_statistics/Dispersal_statistics_2nd_wave_ext2/",analysis)
dir.create(file.path("All_dispersal_statistics/Dispersal_statistics_2nd_wave_ext2/"), showWarnings=F)
spreadStatistics(localTreesDirectory, nberOfExtractionFiles, timeSlices, onlyTipBranches, showingPlots, outputName, nberOfCores, slidingWindow) 
localTreesDirectory = paste0("Phylogeographic_runs/1st_wave_Liege")
outputName = paste0("All_dispersal_statistics/Dispersal_statistics_1st_wave_Liege/",analysis)
dir.create(file.path("All_dispersal_statistics/Dispersal_statistics_1st_wave_Liege/"), showWarnings=F)
spreadStatistics(localTreesDirectory, nberOfExtractionFiles, timeSlices, onlyTipBranches, showingPlots, outputName, nberOfCores, slidingWindow) 
localTreesDirectory = paste0("Phylogeographic_runs/2nd_wave_Liege")
outputName = paste0("All_dispersal_statistics/Dispersal_statistics_2nd_wave_Liege/",analysis)
dir.create(file.path("All_dispersal_statistics/Dispersal_statistics_2nd_wave_Liege/"), showWarnings=F)
spreadStatistics(localTreesDirectory, nberOfExtractionFiles, timeSlices, onlyTipBranches, showingPlots, outputName, nberOfCores, slidingWindow) 

tab = read.table(paste0("All_dispersal_statistics/Dispersal_statistics_1st_wave_ext2/",analysis,"_estimated_dispersal_statistics.txt"), header=T)
...
tab = read.table(paste0("All_dispersal_statistics/Dispersal_statistics_2nd_wave_ext2/",analysis,"_estimated_dispersal_statistics.txt"), header=T)
vS = round(tab[,"weighted_branch_dispersal_velocity"]/366,1); cat(median(vS)," km/day (95% HPD interval = [",quantile(vS,0.025),"-",quantile(vS,0.975),"])",sep="")
tab = read.table(paste0("All_dispersal_statistics/Dispersal_statistics_1st_wave_Liege/",analysis,"_estimated_dispersal_statistics.txt"), header=T)
vS = round(tab[,"weighted_branch_dispersal_velocity"]/366,1); cat(median(vS)," km/day (95% HPD interval = [",quantile(vS,0.025),"-",quantile(vS,0.975),"])",sep="")
tab = read.table(paste0("All_dispersal_statistics/Dispersal_statistics_2nd_wave_Liege/",analysis,"_estimated_dispersal_statistics.txt"), header=T)
vS = round(tab[,"weighted_branch_dispersal_velocity"]/366,1); cat(median(vS)," km/day (95% HPD interval = [",quantile(vS,0.025),"-",quantile(vS,0.975),"])",sep="")

if (showingPlots)
	{
		ats = c(decimal_date(ymd("2020-02-01")), decimal_date(ymd("2020-03-01")), decimal_date(ymd("2020-04-01")),
				decimal_date(ymd("2020-05-01")), decimal_date(ymd("2020-06-01")), decimal_date(ymd("2020-07-01")),
				decimal_date(ymd("2020-08-01")), decimal_date(ymd("2020-09-01")), decimal_date(ymd("2020-10-01")), decimal_date(ymd("2020-11-01")), maxYear)
		mcc = read.csv("Phylogeographic_runs/All_clades.csv", head=T)
		minYear = min(mcc[,"startYear"]); maxYear = max(mcc[,"endYear"])
		col1 = rgb(100, 100, 100, 255, maxColorValue=255)
		col2 = rgb(100, 100, 100, 80, maxColorValue=255)
		col3 = rgb(100, 100, 100, 40, maxColorValue=255)
		dev.new(width=7, height=4); par(mgp=c(0,0,0), oma=c(1,1,0.5,0.5), mar=c(1.5,1.5,1,1))
		plot(tab1[,1], tab1[,2], type="l", axes=F, ann=F, ylim=c(0,7.5), xlim=c(decimal_date(ymd("2020-02-15")),maxYear), col=NA)
...
for (i in 1:dim(mcc)[1])
	{
		...
		if (mcc[i,"endYear"] < decimal_date(ymd("2020-06-01"))) cols[i] = colours[1]
		if (mcc[i,"startYear"] > decimal_date(ymd("2020-08-31"))) cols[i] = colours[2]
	}
if (showingPlots)
	{
